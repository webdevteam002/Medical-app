      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <div className="p-8 max-w-5xl">
          <div className="bg-white rounded-xl border border-slate-200 p-8 shadow-sm text-center">
            <h2 className="text-lg font-semibold text-slate-900 mb-2">Subscriptions Management</h2>
            <p className="text-sm text-slate-500">
              Subscription overview and manual plan grant interfaces will be implemented in later days per the roadmap.
            </p>
          </div>
        </div>
      </main>
