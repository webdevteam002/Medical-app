    ...
    <aside className="w-64 bg-slate-900 text-slate-100 flex flex-col flex-shrink-0 min-h-screen">
      ...
      <div className="p-4 border-t border-slate-800 space-y-2">
        <button
          ...
          className="flex items-center justify-center w-full px-4 py-2 text-xs font-semibold text-red-400 bg-slate-800 hover:bg-red-950 hover:text-red-300 rounded-md transition-colors border border-red-900/30"
        >
          Sign Out
        </button>
      </div>
